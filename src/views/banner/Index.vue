<template>
    ...
    <!-- 新增、编辑 -->
    <add-banner ref="addRef" @on-fresh="getList"></add-banner>
  </template>
  ...
  //表格业务
  const { getList, listParm, resetBtn, searchBtn,sizeChange,currentChange,tableHeight,tableList } = useBannerTable();
  //增删改业务
